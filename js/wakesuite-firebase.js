...
function ws91RequireSuperAdmin(){requireApprovedAccess();if(window.currentWakeSuiteAccess?.role!=="super_admin")throw new Error("Data Administration is restricted to Super Admin.");}
