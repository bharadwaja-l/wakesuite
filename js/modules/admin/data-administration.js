...
(function(){
  ...
  const sourceImpact={wakefit_daily_pricing:['amazon_pricing','flipkart_pricing','inventory'],amazon_all_listings:['amazon_pricing','amazon_suppression','amazon_buybox','inventory'],amazon_fba_inventory:['amazon_pricing','amazon_suppression','amazon_buybox','inventory'],amazon_business_reports:['amazon_pricing','amazon_suppression','amazon_buybox'],marketplace_audit_report:['amazon_pricing','amazon_suppression','amazon_buybox','flipkart_pricing'],shared_audit_report:['amazon_pricing','amazon_suppression','amazon_buybox','flipkart_pricing'],flipkart_listing_file:['flipkart_pricing','inventory'],flipkart_listing:['flipkart_pricing','inventory'],flipkart_order_report:['flipkart_pricing'],flipkart_orders:['flipkart_pricing']};
