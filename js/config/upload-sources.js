...
(function(){
  const S={
    ...
    pricing_exceptions:{label:'Pricing Exceptions',requiredAny:[['wf sku','az sku','asin','fk sku','fsn']],aliases:{wfSku:['wf sku'],azSku:['az sku'],asin:['asin'],fkSku:['fk sku'],fsn:['fsn']}}
  };
